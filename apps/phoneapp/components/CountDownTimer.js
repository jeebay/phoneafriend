...
//
// Made by Uken (https://github.com/uken/react-countdown-timer/blob/master/countdown_timer.jsx)
//
//
// props:
...
var CountdownTimer = React.createClass({
  ...
  render: function() {
    ...
    return (
      <div style={styles.base} className='timer'>
        Available for the next {this.getFormattedTime(timeRemaining)}
      </div>
    );
  }
});
...
module.exports = Radium(CountdownTimer);